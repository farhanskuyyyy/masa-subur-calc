    ...
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 mb-6 border-b border-rose-100">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3.5 py-2 rounded-xl bg-white border border-rose-200 hover:bg-rose-50 text-rose-800 text-xs font-semibold transition-colors flex items-center gap-1.5 cursor-pointer shadow-sm"
          >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="font-display font-bold text-lg sm:text-xl text-ink-primary">
                Data Siklus Menstruasi Anda
              </h2>
              <p className="text-xs text-ink-secondary">
                Masukkan informasi haid untuk menghitung masa subur dan ovulasi
              </p>
            </div>
          </div>
          <button
            ...
            onClick={() => {
              ...
              setLutealPhase(14);
              setIsVariable(false);
              showToast('Data contoh siklus 28 hari diterapkan.');
            }}
            className="text-xs font-medium text-rose-700 hover:text-rose-900 bg-rose-50 hover:bg-rose-100 px-3 py-1.5 rounded-xl border border-rose-200 transition-colors cursor-pointer"
          >
      ...
      {hasCalculated && calculatedMetrics && todayEval && (
        <section ref={resultsRef} className="space-y-8">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-flo-card border border-rose-100 text-center relative overflow-hidden">
            ...
            <div className="relative w-64 h-64 sm:w-72 sm:h-72 mx-auto my-2 flex items-center justify-center">
              <svg className="w-full h-full" viewBox="0 0 240 240">
                ...
                />
                <defs>
                  <linearGradient id="floGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          {/* 4 KEY RESULT CARDS (EXACT PINK/ROSE/AMBER/EMERALD/VIOLET PALETTE) */}
